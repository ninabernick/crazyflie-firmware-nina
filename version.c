...
const char * V_SLOCAL_REVISION="16";
const char * V_SREVISION="4ccc658ba6d6";
const char * V_STAG="v1.0 +16";
...
const uint32_t V_REVISION_0=0x4ccc658b;
const uint16_t V_REVISION_1=0xa6d6;
