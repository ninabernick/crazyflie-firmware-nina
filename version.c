...
const char * V_SLOCAL_REVISION="15";
const char * V_SREVISION="4edfa90ef4fc";
const char * V_STAG="v1.0 +15";
...
const uint32_t V_REVISION_0=0x4edfa90e;
const uint16_t V_REVISION_1=0xf4fc;
